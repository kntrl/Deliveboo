            ...
            <div class="form-create-body">
                ...
                <form method="POST" action="{{ route('admin.foods.update', ['food' => $food->id]) }}" >
                    ...
                    <div class="btn-edit">
                        ...
                        {{-- EDIT --}}
                        <button type="submit" id="edit" name="edit" class="btn btn-outline-success">
                            Modifica piatto
                        </button>
                ...
                <div class="delete-form">
                    <form action="{{route('admin.foods.destroy', ['food' => $food->id])}} " method="post">
                        ...
                        <input type="submit" id="delete" name="delete" class="btn btn-outline-danger" value="Elimina piatto">
                    </form>
                </div>
            </div>
        </div>
